...
export default function PostForm({formAction, initialData}:PostFormProps){
    ...
    <form action={action}>
        <div className="w-96">
            <div className="mb-4">
                <label htmlFor="title" className="bloxk mb-2">Title</label>
            ...
            <div className="mb-4">
                ...
                <textarea name="content" id="content" defaultValue={initialData.content} className="rounded p-2 w-full"></textarea>
                {
